...
//    auto m1_1_0 = std::chrono::system_clock::now();
...
//    auto m1_1_1 = std::chrono::system_clock::now();
//    std::cout<< "m1_1_1 time:" << std::chrono::duration_cast<std::chrono::microseconds>(m1_1_1 - m1_1_0).count()/1000.0 << "ms" << std::endl;
...
//    auto m1_1_1_0 = std::chrono::system_clock::now();
    DYNAMICM cost_matrix = (distance_metric->*(distance_metric_func))(
                tracks, detections, track_indices, detection_indices);
//    auto m1_1_1_1 = std::chrono::system_clock::now();
...
//    auto m1_1_1_2 = std::chrono::system_clock::now();
//    std::cout<< "m1_1_1_1 time:" << std::chrono::duration_cast<std::chrono::microseconds>(m1_1_1_1 - m1_1_1_0).count()/1000.0 << "ms" << std::endl;
//    std::cout<< "m1_1_1_2 time:" << std::chrono::duration_cast<std::chrono::microseconds>(m1_1_1_2 - m1_1_1_1).count()/1000.0 << "ms" << std::endl;

...
{
//    auto tu0 = std::chrono::system_clock::now();
    TRACHER_MATCHD res;
    _match(detections, res);
//    auto tu1 = std::chrono::system_clock::now();
...
//    auto tu2 = std::chrono::system_clock::now();
    //#ifdef MY_inner_DEBUG
...
//    auto tu3 = std::chrono::system_clock::now();
//    std::cout<< "tu1 time:" << std::chrono::duration_cast<std::chrono::microseconds>(tu1 - tu0).count()/1000.0 << "ms" << std::endl;
//    std::cout<< "tu2 time:" << std::chrono::duration_cast<std::chrono::microseconds>(tu2 - tu1).count()/1000.0 << "ms" << std::endl;
//    std::cout<< "tu3 time:" << std::chrono::duration_cast<std::chrono::microseconds>(tu3 - tu2).count()/1000.0 << "ms" << std::endl;
...
//    auto m1 = std::chrono::system_clock::now();
    TRACHER_MATCHD matcha = linear_assignment::getInstance()->matching_cascade(
                ...
                detections,
                confirmed_tracks);
//    auto m1_1 = std::chrono::system_clock::now();
...
//    std::cout<< "m1 time:" << std::chrono::duration_cast<std::chrono::microseconds>(m1 - m0).count()/1000.0 << "ms" << std::endl;
//    std::cout<< "m1_1 time:" << std::chrono::duration_cast<std::chrono::microseconds>(m1_1 - m1).count()/1000.0 << "ms" << std::endl;
//    std::cout<< "m2 time:" << std::chrono::duration_cast<std::chrono::microseconds>(m2 - m1).count()/1000.0 << "ms" << std::endl;
//    std::cout<< "m3 time:" << std::chrono::duration_cast<std::chrono::microseconds>(m3 - m2).count()/1000.0 << "ms" << std::endl;
...
//    if (_next_idx>1073741824)
//        _next_idx -= 1073741824;
//    _next_idx += 3000000000000000000;
    _next_idx += 1;
}
...
//    auto gate0 = std::chrono::system_clock::now();
    DYNAMICM cost_matrix = this->metric->distance(features, targets);
//    auto gate1 = std::chrono::system_clock::now();
    DYNAMICM res = linear_assignment::getInstance()->gate_cost_matrix(
                this->kf, cost_matrix, tracks, dets, track_indices,
                detection_indices);
//    auto gate2 = std::chrono::system_clock::now();
//    std::cout<< "gate1 time:" << std::chrono::duration_cast<std::chrono::microseconds>(gate1 - gate0).count()/1000.0 << "ms" << std::endl;
//    std::cout<< "gate2 time:" << std::chrono::duration_cast<std::chrono::microseconds>(gate2 - gate1).count()/1000.0 << "ms" << std::endl;
    return res;
}
